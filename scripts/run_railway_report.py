#!/usr/bin/env python3
"""Resolve Railway Postgres URL and run harness_analytics report."""
...
def main() -> None:
    url = _public_db_url()
    out = str(REPO / "harness_railway_report.xlsx")
    cmd = [sys.executable, "-m", "harness_analytics", "report", "--db-url", url, "--output", out]
