...
def _analytics_field_pairs(aa: ApplicationAnalytics) -> list[tuple[str, object]]:
    pairs: list[tuple[str, object]] = [
        ...
        (ANALYTICS_REPORT_HEADER_LABELS["oa_ext_1mo_count"], aa.oa_ext_1mo_count),
        (ANALYTICS_REPORT_HEADER_LABELS["oa_ext_2mo_count"], aa.oa_ext_2mo_count),
        (ANALYTICS_REPORT_HEADER_LABELS["oa_ext_3mo_count"], aa.oa_ext_3mo_count),
        (ANALYTICS_REPORT_HEADER_LABELS["oa_ext_gt_90d_count"], aa.oa_ext_gt_90d_count),
        ...
        (ANALYTICS_REPORT_HEADER_LABELS["ctrs_ext_gt_90d_count"], aa.ctrs_ext_gt_90d_count),
